...
环境变量dyjsb
只需要sessionid = 5158cb2f338109d29a1a425eb5ff081f     的值！

方法：搜索"羊了个羊"，替换成你抓包出来的数据，就可以秒开宝箱了，但宝箱视频还是慢。
[可选]优化：其他url相关字段的替换和headers内容的优化，自行研究。
[叼毛]多账户怎么办自己研究！
*/
const $ = new Env("极速死参版");
let envSplitor = ["\n"];
let defaultUA = "com.ss.android.ugc.aweme.lite/250101 (Linux; U; Android 12; zh_CN_#Hans; LIO-AL00; Build/HUAWEILIO-AL00;tt-ok/3.12.13.1)";
let httpResult,
  httpReq,
  httpResp,
...
class UserInfo {
  ...
  async ["openbox2"]() {
    try {
      let url = "https://api3-normal-c.amemv.com/luckycat/aweme/v1/wallet/profit_detail_page?income_type=2&offset=0&num=50&share_page=profits_detail_page&key=coin&iid=4048838205394567&device_id=1497971227368670&ac=wifi&channel=31575073k&aid=2329&app_name=douyin_lite&version_code=250100&version_name=25.1.0&device_platform=android&os=harmony&sub_os_api=8&ssmix=a&device_type=LIO-AL00&device_brand=HUAWEI&language=zh&os_api=31&os_version=12&openudid=7178193c89cbcd0d&manifest_version_code=250101&resolution=1176*2328&dpi=480&update_version_code=25109900&_rticket=1684497219841&package=com.ss.android.ugc.aweme.lite&mcc_mnc=46000&gold_container=0&cpu_support64=true&host_abi=arm64-v8a&is_guest_mode=0&app_type=normal&minor_status=0&appTheme=light&need_personal_recommend=1&is_android_pad=0&ts=1684497218&cdid=aa8b4815-5915-42f8-9f06-afd1b75f8399&oaid=00000000-0000-0000-0000-000000000000&rom=EMUI&has_alipay=1&p_switch=1&launch_method=enter_launch&rom_version=EmotionUI_13.0.0&luckydog_base=WZRgA-MIffxYu9DpoZssTXQ2k-dqiyWULGQOkj24IqsVZ5npxAbc-BVXqMv3ZQBM5tkGzAGvKybuUN0GpB49c9Zqw-vbnxKTX-MHgPe-lWLRl39Ji-P9zc0ePRswH5EsKLFVIdniU7kP90OprjKadNeRJAOIRLwCLenKzj98VWa0Lx-ygEOutqqf7qCw2J76&luckydog_data=VQzTPg0vu-yVnkSAYCXZBk_FOj-TQl16PnYkaQ8LPBh2w0ix40FzD9Wv4BZELB4iJF6QzSsV-_8tB-LFiTGSadhTDaADgMfakOy6ZUQmueikO1keSiyF1gEKSmkE5Iab_ReMCIK864KnQPEHxsABqolU3djAyx5Fp20xCkI55gLGK-EzTUNz9uBIeco8WfW9Qcg0P99cLNY6bHqbnwbFYB3N3n5SdieUK_sVIptFYNEF8l3kpLNhv5AGwancAdJZP1mih6_PtmWjNUxQcHJBozn_fvfN2arGK19KrsdmIQc&luckydog_token=JZ5JRBV-b-wZ3uKA9muauM-d8PjgooMdtpaaAEQFxkLkiKZfTKA4BdL1JupkmI-kLl3r50NpkY1oT4sbrJySvA&luckydog_sdk_version=8.1.0-rc.17-dy&luckydog_api_version=8.1.0-rc.17-dy&static_settings_version=49&dynamic_settings_version=49&polling_settings_version=0&luckycat_version_name=8.1.0-rc.17-dy&luckycat_version_code=810017&lucky_is_32=0&lucky_device_score=8.8842&lucky_device_type=LIO-AL00&status_bar_height=23",
        body = "{}",
  ...
  let _0xeab3e5 = url.replace("//", "/").split("/")[1],
    hd = {
      ...
      headers: {
        ...
        "x-gorgon": "8404403500009c98658a4519e356093549c90739182306b5cca4" ,
        "x-korons": "1684497220",
      },
      timeout: 10000,
    };
